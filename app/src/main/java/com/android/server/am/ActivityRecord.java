...
public final class ActivityRecord {
    ...
    static final boolean DEBUG_SAVED_STATE = false; // ActivityStackSupervisor.DEBUG_SAVED_STATE;
    ...
    final ComponentName realActivity = null;  // the intent component, or target of an alias.
    final String shortComponentName; // the short component name of the intent
    final String resolvedType; // as per original caller;
    final String packageName = null; // the package implementing intent's component
    final String processName = null; // process where this component wants to run
    final String taskAffinity = null; // as per ActivityInfo.taskAffinity
    final boolean stateNotNeeded = false; // As per ActivityInfo.flags
    boolean fullscreen; // covers the full screen?
    final boolean noDisplay = false;  // activity is not displayed?
    ...
    final String baseDir = null;   // where activity source (resources etc) located
    final String resDir = null;   // where public activity source (public resources etc) located
    final String dataDir = null;   // where activity data should go
    ...
    */
    ...
    public boolean mayFreezeScreenLocked(ProcessRecord app) {
        ...
        return false; // app != null && !app.crashing && !app.notResponding;
    }
    ...
    */
    ...
    public long getKeyDispatchingTimeout() {
        synchronized(service) {
           // ActivityRecord r = getWaitingHistoryRecordLocked();
            return 0; // ActivityManagerService.getInputDispatchingTimeoutLocked(r);
        }
    }
    ...
    public boolean isInterestingToUserLocked() {
        return false; /*visible || nowVisible || state == ActivityState.PAUSING ||
